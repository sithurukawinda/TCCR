...
function toUser(id: string, data: FirebaseFirestore.DocumentData): User {
  ...
  return new User({
    ...
    tempReportAccess:           (data.tempReportAccess           as boolean | undefined) ?? false,
    reportsFullAccess:          (data.reportsFullAccess          as boolean | undefined) ?? false,
    temporaryMasterAccess:      (data.temporaryMasterAccess      as UserProps['temporaryMasterAccess'] | undefined) ?? null,
